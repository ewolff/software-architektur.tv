...
✅ **Use Cases statt User Stories** – Detaillierte Ablaufbeschreibungen als "Task-Liste" für KI
✅ **Self-Contained Systems** – Kleinere, unabhängige Systeme für besseren Kontext
✅ **Full-Stack Ansatz** (z.B. Vaadin + Spring Boot) – Eine Sprache, ein Ökosystem, weniger Overhead
✅ **Dokumentation als Code** – Markdown-basierte Spezifikationen, nicht versteckt in Confluence

## Das Spannende:

Simon verwandelt Legacy-Systeme nicht nur, sondern dokumentiert sie so präzise, dass er 10 Jahre später die ganze App neu generieren könnte – wenn sich die Technologie ändert.
