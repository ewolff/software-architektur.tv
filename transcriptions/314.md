# Folge 314 - KI Coding Produktivität mit Ingo Eichhorst Hier ein Hinweis in eigener Sache.

Software-Architektur im Stream ist live vor Ort.

Wir sind beim Tech Rider Summit im Juni in Köln dabei.
...
Ich meine, die beiden anderen Metrie-Sachen sind bei Archives wichtig.
...
Also ich habe das so verstanden, dass Archives halt preprint ist.
...
Archives entspricht dem Standard nicht.
...
Und das bedeutet, diese dritte Sache von Metrie ist halt einfach so, dass sie halt gar keinem Standard entspricht.
...
Das hatten wir vorhin diskutiert, wo diese Metrie-Studien hat.
...
Wir haben hier noch Quote-Helds von dem Adam Tornel.
...
Hier sieht man, wenn der Quote mit höherer Quote-Helds, also mit einer höheren Qualität, reinkommt.

Das wurde hier mit dem Quote-Helds-Tool, das Adam auch entwickelt, gemessen.

Dann sieht man hier ganz klar, dass die Break-Rate, also die Wahrscheinlichkeit, dass etwas kaputt geht, runtergeht.

Das korreliert extrem stark mit der Gesundheit des Quotes.
...
Das deutet extrem stark darauf hin, dass ein aktuell guter Hebel dafür ist, wenn man seine Software quasi für KI fit machen will, jetzt ein guter Moment ist, diese klassischen Quote-Helds-Metriken zum Beispiel anzuwenden.
