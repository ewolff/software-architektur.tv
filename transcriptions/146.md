# Folge 146 - Mehr als Pfeile und Kästen - Architekturdiagramme mit Ralf D.

Müller und Lisa Schäfer Mein Name ist Eberhard Wolff und freitags mache ich auf YouTube und Twitch einen Videostream, oft zusammen mit Gästen zum Thema Software-Architektur.
...
Ich bin als Chef-Architekt bei der DB Sustel, dem IT-Partner der Bahn, eingestellt und kümmere mich da um alle möglichen Probleme, aber vor allem um mein Steckenpferd Architektur-Dokumentation.
...
Und so bin ich dann zum DOCSIS-Code-Ansatz gekommen und ARC42 und seitdem baue ich das immer weiter aus, dass es immer leichter wird, eben dieses Gespann zu nutzen.

Was waren die ersten Tools, mit denen du dokumentiert hast, also bevor du zu dem DOCSIS-Tool-Ansatz kamst?
...
Und wir sind ja jetzt beim Diagramm, da ist ja, ja, Diagramme im DOCSIS-Code-Ansatz, Plant-URL und sowas, ist ja immer nicht ganz so einfach zu handeln.
...
Ich erlebe es bei Techies immer wieder, dass sie den DOCSIS-Code-Ansatz lieben.
...
Das Interessante ist, also mittlerweile unterstützt die Dock-Tool-Chain nicht nur Asciidog, sondern auch Markdown und Restructured Text und über Plugins kann man theoretisch noch weitere Markup-Sprachen reinnehmen.

Und dann hängt es an der Markup-Sprache, was die unterstützt.

Und Asciidog, das ist das, was ich immer empfehlen würde, unterstützt auch Mermaid.
...
Und Asciidog hat Support für den Croquiserver, dass ich einfach über zwei Attribute den konfiguriere.
...
Und von daher, ich meine, das Arc 42 Template, das bringt ja schon einige Vorschläge für bestimmte Diagrammtypen zusammen und das sind dann eigentlich auch so die groben Diagrammtypen, die ich immer benutze.
