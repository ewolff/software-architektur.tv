# Episode 36 - Simon Brown - C4 Architecture Model and Structurizr Mein Name ist Eberhard Wolff und freitags mache ich auf YouTube und Twitch einen Videostream, oft zusammen mit Gästen zum Thema Software-Architektur.
...
Weitere Informationen, Sketch Notes, Übersichten über weitere Folgen gibt es unter software-architektur.tv.
...
So, but nowadays, you're mostly focusing on C4, I guess, and Structurizer.
...
And in there, I have a documentation template, which actually looks really much like ART42 with different section headings and different orderings.

And it's quite funny because I was completely unaware of ART42 when I wrote this.

But having met the ART42 folks, we basically agreed on the same stuff, just in a different order.

So I'm quite happy to recommend my template or the ART42 template with some good diagrams in between.
...
And that's the big problem with most diagramming tools out there, including whiteboards, including Visio, OmniGraph, or Draw.io, even Plant, Email, Mermaid, all of these tools where you're just drawing diagrams, and you have individual tabs or individual files for defining a diagram.
...
And that's essentially what Structurizer allows you to do.

So I think I've overcomplicated things now, because Structurizer is so many different things that have been built over the years.
...
Or there's also the capability to export the diagrams in that domain-specific language to plant UML, Mermaid, WebSequence diagrams, and Eligraph.
