...
So this time it's going to be with Kope about Software-Architektur, what it really is about.
...
At the end of the day, I'm talking about information hiding, the stuff that Panos was talking about, and I think it's the reason why we care about dependencies.
...
Because of that, you call it intuition, or you could call it the theory that Noah is talking about.
...
So you said that a bank account is an audit lock, and let's assume that we spend some time working on that concept.
