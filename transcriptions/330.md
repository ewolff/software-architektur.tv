# AI as a Mirror — a Conversation with Kevlin Henney A note from our team.
...
And could it be that you started the 97 Things series, 97 Things, Jouda Developers to Know, something like this?
...
And every time I see some screen where the boot screen or something like this on an airport, I always think about, hey, that's a Kevin Henney.
...
And most people are actually doing worse than they were before they adopted a idols.
...
Then that is failure to answer.

Most of what developers now do is failure to bond.

And that has been the case for many years.

Now we throw in a high.
...
You know, what we find is even anthropic of finding this is just like, oh, they get a slight uptick with the number of bugs they get.

They've got more bugs.

If you use a high, you will get more bugs, which goes back to why it is that testing is far more important.
...
Then feel free to add them to Treff.desh, an uncommercial platform for tech events in the German-speaking community.

It's free, without any advertising or tracking.

Just visit treff.desh or scan the QR code.

You will also find that link in the video description.

And by the way, you can find all Software Architecture stream events also on treff.desh.
