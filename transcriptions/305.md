# Episode 305 - Splitting without Splitting (Tsvetelina Plummer, Pricillia Gunawan) Okay, so welcome to another episode of Software-Architektur im Stream from the AgileMeets Architecture conference here in Berlin.

They were kind enough to provide us with some space to do this episode, so thanks a lot.

And I'm sitting here with Svetlana and Priscilla and we are talking about splitting without splitting, so that's the name of your talk.

So first, do you want to say a few words about yourself?

Do you want to start?

Yeah, hi, I'm Priscilla Gunnawa, so I'm an Agile coach together with Svetlana in NIQ.
...
So, then let's also go back to the forces that Svetlana was talking about.
