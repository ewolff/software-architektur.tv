...
Also ich habe irgendwie insgesamt 61, 65 Folien.

Ich glaube nicht, dass wir das schaffen.

Das Konzept von dem Stream ist ja, da Timegebox zu sein und nicht auch insbesondere, wenn ihr Fragen habt, noch die Fragen zu diskutieren.

Und Hintergrund der ganzen Geschichte ist halt, ich mache für SoCreatore dieses Flex-Training.

Das ist vom ISA-Kubi und ich habe tatsächlich auch mal den Lehrplan selber mit entworfen.
...
Und da gibt es die Rabatt-Codes, also Flex, Anderbar, Eberhard, Anderbar 10, Anderbar 25, für das im Oktober und für die im Dezember ist es Anderbar 12, Anderbar 25, sonst wieder auch wieder Flex, Anderbar Eberhard, Anderbar 12, Anderbar 25 in dem Fall.
...
Können wir ja machen, indem wir Microsoft-Services benutzen.

Dann haben wir die Möglichkeit, technische Entscheidungen dezentral zu fällen, für jeden Microsoft-Service eine Programmiersprache zu benutzen, die hat unabhängig voneinander zu deployen, unabhängig voneinander zu skalieren.

Viele von den Entscheidungen können wir dann dezentral treffen und sind dadurch flexibel.

Nicht jeder Microsoft-Service kann da anders aussehen.

Wir sprechen sehr viel über Fachlichkeit, wie wir Fachlichkeit vernünftig strukturieren, was ja auch ein Thema ist, was wir im Stream öfter gemacht haben.

Und wir sprechen tatsächlich auch über organisatorische Maßnahmen, die da helfen können.
...
Und wenn ich die jetzt eben wie alle dort Entscheidungen und Abwägungen entgegen treffe, nicht mehr so überlege, will ich Microservices mit dieser starken technischen Unabhängigkeit oder will ich das vielleicht nicht, weil das zu viel Aufwand ist, dann komme ich halt am Ende am Ziel an.

Und das war so ein bisschen der Hintergrund.

Und natürlich ist es halt bei diesen Sachen immer ganz spannend zu schauen, was ihr so sagt.

Und ich habe jetzt die Präsentation aufgeteilt in mehrere Bereiche.

Der erste Bereich ist das hier.

Das sind also Dinge, wo ich irgendwie nachgedacht habe.

Wir sehen hier so ein Nachdenkendes Emoticon.
...
Das ist eine Kategorie von Antworten, die da ist.

Also die Rückfrage, mit welcher Art von Flexibilität ist eigentlich gemeint, bis hin zu Leuten, die sagen, so etwas wie Flexibilität gibt es gar nicht.

Und ich würde sagen, Flexibilität ist die Möglichkeit, auf Änderungen zu reagieren.

Das wäre Flexibilität.
...
Bei einer technischen Architektur kann ich auf technische Änderungen reagieren, neue Programmiersprache einführen, solche Sachen.

Bei der organisatorischen Ausrichtung sorge ich dafür, dass ich diese technischen Mechanismen ausnutzen kann und dass ich eben auch dort in der Organisation flexibel bin und mich also entsprechend unterschiedlich aufstellen kann.

Was macht ein Unternehmen?

Es passt sich an sich ändernden Kontext an, oder?
...
Das ist ja die Idee von dem Stream, eben mal sozusagen auch mit euch zu interagieren.
...
Unsere Disziplin ist sehr jung, wir müssen die Theorien schärfen.
...
Und das hat mich halt deswegen dazu angerichtet, sozusagen nochmal was dazu zu sagen, weil ich behaupten würde, die Dinge, die dort als Metaphern genutzt werden, also ein Arzt, der eine Armprothese rausgibt, die dann als Bein verwendet wird.

Wir bauen auch keine CRMs, die morgens als LLM genutzt wird.

Also wir haben eine Flexibilität, ich muss eben dafür sorgen, dass mein CRM auf irgendwelche Änderungen reagiert.
...
Aber also die Frage ist erstmal, was ist unsere Disziplin?
...
Da geht es genau darum, wann wir eigentlich das erste Mal angefangen haben, Systeme halt im Team gemeinsam zu bauen.

Das ist seit den 50ern.

Und das ist halt ein bisschen länger, als ich lebe.

Also ich bin Jahrgang 2017.

Das heißt, das ist gut 20 Jahre länger, als ich lebe.

Das bedeutet also, ich kann tatsächlich mit den Erfahrungen dieser ersten Generation ganz locker ausgestattet werden.

Ich habe in den 90ern studiert, seit ab 93.

Das heißt also, ich kann irgendwie mit 40 Jahren Hintergrundwissen über Softwareentwicklung ausgebildet werden.

Bin das halt auch geworden.
...
Wenn wir das großzügig auslegen, also Softwareentwicklung, Iterationen, das ist halt auch ein Thema aus den 60ern, Brooks, Mythic Man-Month, nachdem man eben nicht, wenn man ein Projekt zu spät hat, noch mehr Menschen draufwerfen sollte und dann schneller wird.

Das Buch ist so 1975 herausgekommen.

Das heißt, wir sind vielleicht eine junge Disziplin.

Ich würde sagen, wir haben einen Erfahrungsschatz an Engineering und können darauf aufbauen.

Und ich glaube auch, dass wir uns der Herausforderung stellen müssen, dass wir eben Software bauen müssen, die sich einer ändernden Welt anpasst.

Das ist eben so.

Und ich glaube, da kann die Ansage nicht sein.

Das können wir halt nicht, weil wir haben ja keine Erfahrung, wir sind eine junge Disziplin, finde ich halt schwierig.
...
Das heißt also, er hat gesagt, das geht in drei Schritten.

Erstens, den Elfenbein-Architekten rauswerfen.
...
Also den Elfenbein-Architekten rauswerfen impliziert, dass es jemanden Architekten gibt, dass er im Elfenbeinturm ist, dass man den halt entfernen will.

Ich bin ja bekennender Non-Coding-Architekt und ich hoffe, dass ich das Gegenteil bin.
...
Auch da gibt es halt Diskussionen, die ich irgendwie geführt habe.
...
Sonst wäre ich halt irgendwie sozusagen arbeitslos.

Die Geschichte mit Domain-Design ist insofern richtig, als dass das eben zu fachlicher Flexibilität führt.

Wir haben aber gerade darüber diskutiert, dass es drei Dimensionen sind.

Also technische, organisatorische und eben fachliche Flexibilität.

Das heißt, die anderen Dimensionen werden vernachlässigt.

Das stand in der Frage drin bei LinkedIn.

Von daher ist es ein bisschen komisch, das zu nicht aufzunehmen.

Und diese Geschichte mit der Lebendigen-Architektur, genau.

Also deswegen wollen wir ja irgendwie Flexibilität.

Also damit sie eben lebendig ist und sich anpassen kann und eben nicht, wie dort steht, abgeschlossen ist, sondern eben änderbar.

Führt aber zu der Frage, wie mache ich es denn jetzt?

Also sich eben hinzustellen und zu sagen, ich akzeptiere das, dass sie eben nicht abgeschlossen ist.

Ja, finde ich gut, dass man es akzeptiert, aber das ist kein konstruktiver Vorschlag, der dazu führt, dass wir es jetzt ändern können.

Dann kamen halt irgendwie weitere Fragen.

Also der Urs Enz hat gefragt, also wieso hilft die Idee dabei, flexibel zu sein?

Und Sven Müller hat dann irgendwie geantwortet, erstens erlauben saubere Domain-Schnitte, dass einzelne Module beziehungsweise Services von unabhängigen Teams entwickelt und getrennt voneinander skaliert oder auch komplett ausgetauscht werden können.
...
Das hat insofern Spannend, als dass das eben bedeutet, dass wir nicht über zum Beispiel taktisches Domain-Domain-Design, also über Domain-Domain-Design auf der Ebene von Klassen sprechen, sondern wir sprechen halt über kollaborative Praktiken, Event-Storming, solche Geschichten und Strategic Domain-Domain-Design, also wie wir halt Systeme in größere Teile aufteilen.
...
Also wenn ich die Teams nicht freilasse und nicht dafür sorge, dass sie das eben tatsächlich auch tun dürfen, dann habe ich zwar vielleicht die Möglichkeit dafür eingebaut in meiner Architektur, aber ich habe es nicht umgesetzt und dann habe ich halt ein Problem.

So, dann gibt es eine weitere Diskussion.

DDD ist ja auch nicht in jedem Business-Kontext die ultimative Lösung, sondern hauptsächlich im Enterprise-Integration unterwegs.

Gibt es andere Design-Prinzipien, die angebrachter sind?

Wir haben zum Beispiel letzte Woche gesprochen, vorletzte Woche, über das, was Netflix da mit einem großen Aufwand macht in Bezug auf Daten-Integration.

Und da kommt irgendwie dann die Antwort klar, auch DDD ist kein Silver-Bullet, so sagt irgendwie Sven Müller.

Die gibt es einfach im echten Leben nicht, weil es bei DDD aber eben darum geht, dass Teams möglichst unabhängig voneinander Mehrwert schaffen können, glaube ich schon, dass man damit nicht ganz falsch steht, wie beim Flexibilität gefordert ist, sondern hat der Rainer Falke, den wir vorhin schon hatten, noch geschrieben, Sven Müller stimmt, dann ist aber keine Lösung, sondern Resignation.

So, was halt wiederum bedeutet, also tatsächlich würde ich eben auch sagen, Domain-Design hat einen bestimmten Ansatz-Kontext, also den, wo es eben darum geht, mit sehr viel Geschäftslogik umzugehen.

Wir haben bei dem Netflix-Beispiel gesehen von der letzten Episode, dass es eben andere Fälle gibt, wo es halt vielleicht eher darum geht, Daten zu analysieren, wo es vielleicht nicht so viele Geschäftslogik gibt, da hilft mir halt klassisches Domain-Design vielleicht gar nicht so viel weiter.

Und insgesamt, das ist vielleicht so ein bisschen das Problem, ich bin halt der Meinung, wenn ich halt, also jetzt ja eigentlich die Aussage, ich habe irgendetwas, ein Team, eine Umgebung und ich kann das halt verbessern, indem ich eben sage, ich schmeiße den Architekten aus und ich mache Domain-Design.

Und das finde ich schwierig, weil kann sein, dass das ja schon funktioniert und dass es halt andere Sachen gibt, die man optimieren muss.

Wenn die Architektin einen guten Job macht oder wenn Domain-Design schon umgesetzt ist, dann hilft mir das halt nicht.

Und da muss ich halt irgendwie flexibel sein.

Ich muss mich adaptieren und gerade die These, dass ArchitektInnen grundsätzlich einen schlechten Job machen, finde ich, ist eine steile These.
...
Das ist der Punkt, welche Art von Flexibilität meinen wir?

Hier meinen wir eine Flexibilität, das ist das, was der Jan im Prinzip sagt, wo wir sagen, es sind unterschiedliche Leute, die an dem System arbeiten können.
...
Ich glaube, tatsächlich einer der determinierenden Faktoren von dem, was wir überhaupt machen in der Softwareentwicklung.

Deswegen bin ich nicht sicher, ob ich das wirklich so als Ziel umsetzen wollen würde, weil es einfach dazu führt, dass ich andauernd neu dieselben Sachen lerne.

Aber das ist vielleicht etwas, was irgendjemand mir aufzwingt und da muss ich eben diese Flexibilität umsetzen.

Wenn man zu dem zurückkehrt, was wir gerade auf der Folie davor gesehen haben, dann hilft mir sowas wie Domain-Tuning gar nicht weiter.

Deswegen fand ich das sehr spannend, weil hier eine ganz andere Interpretation von Flexibilität ist.

Damit steht das sehr gut stellvertretend für die ganzen Anforderungen oder die ganzen Bemerkungen, die hinauslaufen auf das ist ja total cool, dass du flexibel sein willst.

Kannst du mal bitte sagen, was das genau bedeutet?

Hier ist ein schönes Beispiel, was die Aussage ist.

Mit der Flexibilität ist ein ganz anderes Thema.

Jetzt habe ich über den Urs gerade eben gesprochen und er ist tatsächlich hier.

Er sagt, ich könnte jetzt ja auch sagen, dass es nicht die Idee ist, sondern Kollaboration, Modularisierung, guter Fit, Domäne, Software-Design.
...
Dieses Thema, dass eigentlich Modelle interessant sind, weist genau auf diese Sache hin.

Dass Modularisierung interessant ist, dass ich diesen Fit zwischen der Domäne und Software-Design hinbekommen muss.

Das ist etwas, was eben auch außerhalb von Domänen des Designs gilt.

Ein Modell ist etwas, was eine Funktionalität aufteilt oder auch ein Modul.

Das gilt allgemein.

Dann lasst uns mal schauen, dass wir weitermachen.

Dann kam die Aussage von dem Ingo Eichhorst.

Er hat geschrieben, Flexibilität ist eine Illusion.
...
Wir können zwar vorausdenken, was sich in Zukunft eventuell ändern wird und dafür Vorregelungen treffen, aber dann sind wir ja nicht mehr flexibel, sondern haben gut geplant.

Ich finde das halt schwierig, weil ich glaube, die Änderbarkeit eines Systems, auch auf nicht vorhergesehene Sachen, ist etwas, was eine Eigenschaft einer Software sein kann oder eben auch nicht.

Deswegen würde ich behaupten, diese Flexibilität gibt es.

Wenn ich jetzt sage, dass wir das geändert haben, dann ist das eben etwas, wo die Software flexibel sein kann oder auch nicht.

Was ich spannend finde, ist die Geschichte mit dem Vorausdenken.

Das ist tatsächlich auch etwas, wo eine ganze Menge an Antworten von euch gekommen sind, die eigentlich sagen, Vorausdenken ist absichtlich.

Abstraktion einbauen, das ist vielleicht nicht so eine gute Idee.

Wir hatten auch eine Folge, wo wir das diskutiert haben und festgestellt haben, dass es eine Folge zur Wiederverwendung gibt und Product Line Engineering.

Das sind zwei Folgen, wo wir im Prinzip sagen, man kann im Nachhinein erst sagen, ob Dinge wiederverwendet werden sollen.

Dann gibt es, das muss ich mal kurz raussuchen, mit dem Bertian Schrievers über Generic oder Specific, wo er eben auch sagt, wenn ich etwas habe und das baue, dann kann ich erst beim dritten Mal Dinge wiederverwenden und neu bauen.

Das ist auch etwas, was einige von euch später gesagt haben, in diesem nicht einfach bauen und solche Sachen.

Das impliziert das Vorausdenken.

Die falsche Strategie ist so ein bisschen.
...
Es gibt zum Beispiel Sort, mit dem ich irgendwelche Sachen sortieren kann.
...
Aber ja, ich weiß auch nicht, ob Flexibilität endet.

Irgendwann, ob ich das unterschreiben würde.
...
Also kleine spezialisierte Programme schreiben, die zusammen dann als Microservices ein Ergebnis produzieren.

Und das passt zur Flexibilität, weil ich dann diese kleinen Teile austauschen oder ändern kann, ohne dass der Rest geändert wird.

Und das ist eben so der Ansatz, mit dem eben der Microservices oder auch die Unix-Philosophie, ich hatte vorhin darüber gesprochen, dass ich eben nicht glaube, dass es tatsächlich stimmt, zu einer Flexibilität führen.

Gut, Sven Riemann, auch bei LinkedIn, hat geschrieben.

Aus meiner Erfahrung ist die Frage nach flexibler Software-Architektur so allgemein kaum gestellt, kaum zu beantworten.

Genau, ist eine fiese Frage.

Wenn man Flexibilität als Anforderung formuliert, führt das oft zu Over-Engineering.

Es entstehen Frameworks, die alles können sollen, in der Praxis aber oft doch nicht alles abdecken oder nur mit einschränken können, zum Beispiel bei der UX, Relierbarkeit oder Wartbarkeit.
...
Wir müssen das Problem lösen, dann haben wir gute Chancen, eine Software zu bauen, die auch flexibel beantworten kann und insbesondere das fachliche Problem müssen wir lösen.
...
Modularisierung einsetzen und Bereiche klar zu trennen.

Austauschbarkeit und Wartbarkeit zu erhöhen.

Module sind eine gute Idee.

Klare Ziele und Rahmenbedingungen definieren, zum Beispiel erwartete Nutzerzahlen, SLAs.

Wenn das dann geht, also wie viele Benutzer ich erwarte, kann man vorher häufig schwer sagen.
...
LinkedIn entsteht durch klaren fachlichen Rahmenmodularisierung und die Bereitschaft zur laufenden Anpassung.
...
Stimmt ja auch prinzipiell.

Damit ist es ja nur eine Frage von Aufwand.
...
Ich finde, das passt schon, weil man darüber jetzt im Prinzip sagt, ich baue irgendetwas, ich baue es möglichst einfach.

Ich habe einen Feedbackloop im Review, kriege dadurch Feedback, was dann möglicherweise sagt, ist vielleicht doch keine so gute Idee.

Und dann arbeite ich halt weiter und das finde ich passt erstmal.

Urs Enzler schreibt noch und nochmals ein Gedanke.

Es regnet halt immer wieder Benachrichtigungen rein.
...
Strategy-Pattern ist dieses Ding, wo ich eine Klasse habe, die eine bestimmte Strategie, also einen Algorithmus implementiert, vielleicht für Kreditvergabe oder was auch immer, also eine bestimmte Logik.
...
Das heißt, manchmal ist es einfach, die Sachen einfach runter zu koden.

Also das sind wir wieder bei KISS und dann ist man halt fertig.

Urs schreibt weiter, Flexibilität entsteht durch simplen Code, der einfach angepasst und ausgeliefert werden kann.

Also auch wieder kippel-simple.

Was haben wir denn hier?

Flexibel.

Genau, da hat der Simon Martinelli auf BlueSky mich zurückgefragt.
...
Das flexible System ist dann, hier ist eine Programmiersprache, mach es halt selbst.

Das ist halt maximal flexibel und es ist auch maximal unkonkret und es ist maximal unnütz.
...
Also wie soll ich sagen, ich glaube, wenn ich zu jemandem hingehe und sage, soll ich eine unflexible Software bauen, sagt die Person halt, nö.
...
Ich muss mir halt überlegen, wo will ich denn flexibel sein?

Also gibt es fachliche Anforderungen oder will ich technisch flexibel sein?

Da sind wir wieder bei den Qualitätsszenarien und da muss ich das genauer ausdefinieren, sonst wird es halt nichts.

Da kam dann zurück, wenn du keine Anforderungen hast, darfst du dich auch nicht über das Resultat beschweren.

Und da ist ein Bild aus dieser Simpsons Folge, wo Homer Simpson seinen Bruder findet.

Der ist irgendwie Chef von irgendeiner Autofirma.

Und gibt halt Homer den Auftrag, das Traumauto zu bauen.

Da kommt halt etwas Absurdes raus mit ganz vielen komischen Featuren.

Und das ist ein Ergebnis davon, dass eben Homers Bruder, das glaube ich, eben sagt, ist mir völlig egal.

Ich möchte gar nicht wissen, wie du genau vorgehst und was du halt entscheidest.

Ich will nur das Endresultat sehen, ich vertraue dir vollständig.

Und das ist vielleicht wirklich eine Metapher für nicht, wenn ich keine Anforderungen habe, geht es sozusagen schief.

So Urs hat Insta, über den wir schon gesprochen hatten, hat bei LinkedIn eben zurückgeschrieben.

Zuerst mal eine Frage zurück, Flexibilität bezüglich was? Ändernde Business Anforderungen, Evolution des Marktes, Business Motor Marktsegment, Technische Aspekte, Modernisierung, Skalierung.

Wobei ich nicht weiß, ob Modernisierung technisch ist.

Ich würde behaupten, das bedeutet eher eine fachliche Änderung.

Architekturdesign-Konzepte, wir wollen refaktorisieren können, wenn wir eine bessere, einfache, mächtige Lösung finden.

Je nach Antwort dazu sind die Mittel etwas anderes.

Genau und nicht, also Ändernde Business Anforderungen, eher ein fachliches Ding, Technische Aspekte eher ein technisches Ding.

Und Urs schreibt halt weiter, so grundsätzlich wohl nie falsch sind, eine gute Modernisierung, ja, Modernisierung wissen wir halt seit Ende der 60er, dass es eine gute Idee ist. Ändern Business Capabilities, genau, eben um fachliche Flexibilität zu haben.

Und Entkopplung von Infrastruktur, Libraries, Frameworks, wie Imports und Adapters, Architektur.

Da bin ich mir nicht so sicher, denn eine technisch neue Umgebung ist eher ein seltenes Thema.

Also im Mittel, also da werden jetzt irgendwelche Leute sein, die sagen, das passiert bei uns ja mit täglich.

Also täglich vielleicht nicht, aber wir bauen Standards, wir müssen halt eine Vielzahl an unterschiedlichen Datenbanken unterstützen.

Genau, gut, das ist etwas anderes.

Hier ist dann die Aussage, dass man sowas mit Imports und Adapters zum Beispiel bekommt.

Und ich glaube, ein unterschätzter Punkt, oder für mich der wesentliche Punkt bei Imports und Adapters, ist da Testbarkeit.
...
Die UI hängt vom Business Kern ab, sodass ich eben für Tests jetzt sagen kann, okay, ich habe irgendwie so ein Ding, was halt den Business Kern treibt, also die UI ersetzt.

Ich habe irgendetwas, was statt der echten Datenbank da ist.
...
Genau, Urs schrieb halt, das ist ja gerade auch persönlich sozusagen da, und er schreibt halt, gute Testbarkeit, Förderflexibilität auch.
...
Und ich würde, aber das hat man, glaube ich, schon diskutiert, nicht sehen, dass man eine Software zu allem Gewünschten umbauen kann oder überhaupt will.

Einfach deswegen, weil es halt nur eine endliche Menge an Dingen gibt, die ich halt tatsächlich ändern möchte.

Und ich glaube, das herauszufinden und zu begrenzen, ist halt ein wichtiger Punkt.

Also natürlich lässt sich Software prinzipiell zu allem Möglichen umbauen.

Klar, sie ist halt Soft.

Aber es ist halt irgendwann so, dass die Aufwände zu hoch sind.

Und das ist so ein bisschen, glaube ich, eine Grundherausforderung.

So, genau.

Stefan Rote-Stübs hat geschrieben.

Das hängt davon ab, was in diesem Fall mir flexibel gemeint ist und erreicht werden soll.

Lass uns kurz noch durch die weiteren Überschriften gehen.

Also ich habe dann Modularisierung in unterschiedlichen Variationen und Stimmtheit.

Ich will dann mein System in Module aufteilen und dafür sorgen, dass das dadurch sinnvoll änderbar ist.

Dann gab es so Sachen, die mich zum Lächeln gebracht haben.

Das ist gerade so ein lächelnder Emoji.

Also der Stefan Ambruster hat zum Beispiel gesagt, wie die Frage, so die Antwort.

Typ Ernst, klar.

Also hilft nur leider nichts.

Tamo von Lassen hat geschrieben.

Das weißt du doch selbst, wie man Software flexibel bekommt.

Schön auch, Roland Weissleder schreibt, Map, Object, Object, Data.

Also nicht eine Map, wo ich ein Objekt reinwerfe und ich kriege ein Objekt raus.

Das sind meine ganzen Daten.

Das ist ein schönes Beispiel für, ja, das ist eine flexible Datenstruktur.

Das hilft mir nur irgendwie null.

Weil damit kille ich einen Typechecker, den ich möglicherweise habe.

Und ich kann ganz wenig darüber sagen, was da eigentlich drin ist in meinem System.
...
Da gibt es halt von dem Christian Gutrian.

Bei Mastodon die Aussage, schreibe keinen Code, der sich leicht wiederverwenden lässt.
...
Also in gewisser Weise ist das nachvollziehbar, weil sozusagen das Entsorgen von Software, für Legacy-Software zum Beispiel losfährt.
...
Für mich fühlt sich das so medium-toll an.
...
Der Punkt ist halt, ich hätte sie wahrscheinlich nicht gegeben und ich bin mir nicht sicher, ob das im Projektalltag wirklich hilft.

Dann kommt halt von dem RAF Lefebvre, ich hoffe, dass ich das richtig sage, die Aussage Architektur, nicht der Prozess, dem man folgt, oder die Art und Weise, wie die Organisation aufgebaut wird, erzeugt eine gute Softwarefabrik, sondern es gibt diese, also nicht alle drei spielen zusammen.

Und das ist, glaube ich, das, was wir im Training auch haben.
...
So könnten wir mögliche Pfade entwerfen, wie wir die Architektur zu Beginn nicht überdimensionieren und so schnell am Markt sind, und uns aber keine Sackgassen einfangen, wenn wir die Architektur weiterentwickeln.

Ich glaube, dass man den Architekturpfaden stimmt, also es gibt sozusagen einen vorfertigten, also es wird immer eine Evolution geben, also ich werde Architektur immer weiterentwickeln.

Also bei dem konkreten Beispiel bin ich mir nicht sicher, was die Implikation ist.

Ich habe also eine Anwendung mit 100 BenutzerInnen.

Ich nehme mal an, das ist so etwas, was ich jetzt auf meinem gut ausgestatteten Laptop, aber es ist halt ein Laptop, irgendwie laufen lassen kann.

Wenn ich 25.000 BenutzerInnen habe, ist das 250 mal mehr.

Da werde ich wahrscheinlich ein ganz anderes System haben.

Es ist sinnvoll, nicht Dinge zu tun, die halt offensichtlich dumm sind, eine Trautologie würde halt bedeuten, es ist zum Beispiel sinnvoll, das Ganze einigermaßen zustandslos zu machen, sich damit schon mal herumzuschlagen, wie die Pilotbalance da reinkommt, und solche Sachen zu machen.

Aber ich würde auch erwarten, dass ich auf dem Weg von 100 auf 25.000 BenutzerInnen einige Hürden zu nehmen habe, die ich jetzt nicht vorhersehen kann, und die ich nicht planen kann.

Und jedes Mal, wenn ich eine Hürde oder einen Bottleneck eliminiere, geht es einen Schritt weiter.
...
Und das ist sozusagen so, das heißt eigentlich muss ich die Flexibilität, die sollte halt im Vorjahr sein, aber ich kann nicht genau sagen, wo die Bottlenecks sind, das kann ich nicht planen, also muss ich da irgendwie durchlaufen.

Und genau, da kommen dann noch weitere Themen.

Dann noch dieser Hinweis auf Residuality Theory von dem Barry O'Reilly, und das ist genau das, ich hatte auswählend einen Hinweis gebracht, das ist genau das, was wir dann am 19. drüber sprechen werden, dann in englischer Sprache, das ist übrigens etwas, wo uns die Agile Meets, Quatsch, das war für Architecture Gathering, unterstützt Barry in seinem Vortrag, und ich bin sehr gespannt darauf, ich hatte mit ihm schon das Vorgespräch, das wird, glaube ich, eine ganz spannende Episode.

So, der Urs hat jetzt nochmal live gesagt, es gibt mehrere mögliche Pfade ans Ziel, mit jedem Entscheid verändern sich aber die Optionen, genau, was halt impliziert, dass ich es eben nicht planen kann, also ich kann mich jetzt nicht hinstellen und kann sagen, wir haben ein System, das 100 Leute unterstützt, und hier ist halt der Plan, wenn ich auf 25.000 komme, ich werde eben das schrittweise weiterentwickeln und dann irgendwie mich entsprechend anpassen.

Gut, soweit dazu, es gibt am Freitag, also am 5., mit meinem neuen Kollegen, dem Lukas Domen, der war auch mehrmals im Stream schon, eine neue Episode, zusammen mit Lisa, über das Thema Web Performance, das ist also die nächste reguläre Episode, und ansonsten, vielen Dank für die Kommentare, vielen Dank fürs Dasein, wir sehen uns dann, wie gesagt, wahrscheinlich am 19. wieder, vielleicht mache ich zwischenzeitlich auch nochmal eine Episode, für den 12. wird noch nichts weiter geplant, und dann wünsche ich euch noch eine schöne Woche, wir haben ja gerade erst den Montag, also kein schönes Wochenende, sondern eine schöne Woche, ein schönes Wochenende dann auch, und dann, ja, vielen Dank fürs Zuhören, vielen Dank fürs Diskutieren, und bis dahin, danke.