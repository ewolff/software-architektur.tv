# Folge 328 - LLM-basierte Systeme sicher machen mit Sönke Magnussen Wir sind ja auf dem ESRQB Software-Architektur Forum.

Ich sitze hier mit Sönke zusammen.

Hallo Sönke, möchtest du erst mal zwei Worte über dich sagen?

Ja, Sönke Magnus ist mein Name.
...
Du hast ja diesen Talk über IMS-Software-Architektur zusammen mit Amabu Bagabi für agentische Systeme gehalten und das ist halt sehr stark auf ein Sicherheitsthema hinausgelaufen.
...
Ihr hattet halt gesprochen über die, das war neu für mich, es gibt ja traditionell diese Oberost-Top-Ten für Web-Anwendungen.
...
So und diese LLM-OVASP, wenn man so will, Schwachstellen, die OVASP immer sammelt, die haben halt irgendwann gesagt, für agentische Systeme ist das nochmal was Spezielles, was sozusagen on top obendrauf kommt.
...
Denn arbeitet der Agente halt einfach mit einem anderen Ziel.
...
Und man kann auch dieses Tool Misuse, das ist eben ein eigenes Risiko oder eine eigene Schwachstelle, die OVASP dort nennt.
...
Also beispielsweise irgendeine Bestellung bloß schießen, die für irgendeinen fiktiven Provider, wo ich dann später erwarten kann, okay, da kann ich dann nochmal eine extra Rechnung für schreiben.

Und dann hatten wir noch als weiteres Beispiel, oder er hat es so genannt, AgentX Supply Chain, also insgesamt sind es Jahrzehnte, aber dass man noch da eins vorgesagt ist, was halt wichtig ist.
