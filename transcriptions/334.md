# Kubernetes and Software Development with Kelsey Hightower A note from our team.

Hello Software-Architektur im Stream listeners.
...
You will hear the first few episodes on this channel, but if you don't want to miss any episode in the future, you can already subscribe on maschinenraum.fm.
...
Let's build a control plan on top.

Let's build a configuration management system on top.

Let's build a CICD system on top.
