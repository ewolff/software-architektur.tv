# Folge 300 - Agile Doku mit Liam Bergh
...
- Die Definition of Done sollte Dokumentation als gleichberechtigten Bestandteil neben funktionierendem Code enthalten, um Technische Schuld durch aufgestaute Dokumentation zu vermeiden.
- Dokumentation ist kein Selbstzweck, sondern muss kontinuierlich in den Entwicklungsprozess integriert werden, nicht als separater Sprint am Ende durchgeführt werden.
- Zielgruppenorientierung ist das A und O: verschiedene Stakeholder (Entwickler, Projektleitung, Anwender) benötigen unterschiedliche Dokumentationsarten und Darstellungsformen.
- Automatisierung von Dokumentation durch Tooling wie Docs-as-Code und C4-Modelle reduziert Wartungsaufwand erheblich.
...
- Wie unterscheidet sich agile Dokumentation von traditioneller, umfassender Dokumentation?
- Warum dokumentieren Entwickler ungern und wie kann man ihre Motivation erhöhen?
...
- **Diagramms-as-Code 2.0**: Weiterentwicklung von Diagramms-as-Code, bei der die Architektur in einer Domain-Specific-Language beschrieben wird und beliebig viele Diagramme daraus automatisch generiert werden.

- **Technische Schuld**: Angesammelte, nicht durchgeführte Arbeiten (wie Dokumentation oder Code-Refactoring), die zukünftige Entwicklung verlangsamen und später teuer zu beheben sind.
