...
- **DOCSIS-Code-Ansatz**: Strategische Ablage von Dokumentation unmittelbar beim Quellcode im Versionskontrollsystem, ermöglicht Synchronisation und Versionierung von Dokumentation und Code.
...
- **C4-Modell**: Von Simon Brown entwickeltes Ansatz zur Visualisierung von Software-Architektur in vier Abstraktionsebenen (Context, Container, Component, Code).

- **Enterprise Architect Headless**: Technik zur automatisierten Steuerung und Diagramm-Extraktion aus dem UML-Modellierungstool Enterprise Architect ohne grafische Oberfläche.
