# Folge 303 - Hyperscaler Exit mit Lucas Dohmen

## Wichtige Keytakeaways

- Der Hyperscaler-Exit bei FIODK ermöglichte eine Einsparung von 80 Prozent der Infrastrukturkosten durch den Wechsel von AWS zu Hetzner Cloud.
...
- Eine bewusst reduzierte Technologie-Stack (Ruby on Rails, Docker Swarm, PostgreSQL) mit weniger als 10 Services ermöglicht kleineren Teams, die gesamte Infrastruktur zu verstehen und zu betreuen.
- Die politische Motivation (Unabhängigkeit von US-Anbietern) war für FIODK das Haupttreiber des Umzugs, nicht primär die Kosteneinsparungen.
- Simple Cloud-Anbieter bieten weniger Lock-in als Hyperscaler mit ihren 200+ Services und ermöglichen einfacheren Wechsel zu Alternativen.
...
- **Simple Cloud**: Kleinere Cloud-Anbieter wie Hetzner Cloud oder DigitalOcean mit reduziertem Service-Portfolio (unter 10 Services), die Basisfunktionen wie VMs, Load Balancer und Object Storage anbieten.
- **Object Storage**: Speichersystem für unstrukturierte Daten nach dem Key-Value-Prinzip (ähnlich AWS S3), genutzt für große Dateien wie Bilder oder Docker-Images.
