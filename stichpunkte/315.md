...
- Softwareentwicklung wird zunehmend zu einem kollaborativen Teamlernprozess statt Einzelarbeit mit KI-Tools.
- Die Kernkompetenz verlagert sich von Programmierfähigkeiten zur Problemformulierung, Modellbildung und interdisziplinärem Verständnis.
...
- **Large Language Models (LLMs)**: Künstliche Intelligenzsysteme wie Claude, GPT oder Mistral, die trainiert sind, um menschenähnliche Texte zu verstehen und zu generieren und als Sparringspartner für Lernprozesse fungieren.
...
- Firefox, dev.to (Entwickler-Communities)