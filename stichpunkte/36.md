...
- **Structurizr**: A collection of open-source and commercial tools that generate multiple consistent architecture diagrams from a single model definition stored in JSON or domain-specific language format.
...
- **Domain-Specific Language (DSL)**: A text-based Structurizr syntax that allows developers to define software architecture models in a succinct, code-like format that can be parsed into JSON models and exported to various diagram formats.