# Folge 324 - Docs-as-Code trifft GenAI mit Stefan Zörner

## Wichtige Keytakeaways

- Architekturdokumentation ist hochgradig textlastig und eignet sich daher ideal für GenAI-Unterstützung, besonders wenn Diagramme als Code (PlantUML, Mermaid) vorliegen.
...
- Qualitätsziele sollten idealerweise im Team mit Stakeholdern erarbeitet werden – GenAI kann hier eher bei ADRs (Architecture Decision Records) sinnvoll eingesetzt werden.
...
- **Qualitätsszenarios**: Konkretisierung abstrakter Qualitätsziele durch spezifische Szenarien, die messbare Anforderungen an die Systemqualität festlegen.
