# Folge 317 - Zwischen KI-Hype und KI-Vampire - wie wir den Einsatz von KI im Alltag erleben
...
- Der Druck zur schnelleren Produktion entsteht durch Konkurrenzerwartungen, nicht durch echte Produktivitätsgewinne von zehnmal so produktiven Entwicklern
- Standards in Softwareentwicklung steigen durch KI-Einsatz (wie beim Beispiel der Waschmaschine), was zu mehr statt weniger Arbeit führt
- IDEs und Entwicklungswerkzeuge werden zunehmend für LLMs optimiert statt für menschliche Entwickler
- Reviewer-Müdigkeit und kognitives Overload entstehen durch die Menge an KI-generiertem Code, der überprüft werden muss
...
- **Behavioral Driven Development (BDD)**: Testmethodik mit Gherkin-Spezifikationen, die die KI zur automatischen Test-Generierung verwenden kann
...
- Cloud Code (IDE-Plugin von Google für KI-unterstützte Entwicklung)
